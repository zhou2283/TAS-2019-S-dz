	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float temp_output_71_0 =  ( eyeDepth21 - _BandLen > ( ( _SinTime.y + 1.0 ) * 6.0 ) ? 0.0 : eyeDepth21 - _BandLen <= ( ( _SinTime.y + 1.0 ) * 6.0 ) && eyeDepth21 + _BandLen >= ( ( _SinTime.y + 1.0 ) * 6.0 ) ? 1.0 : 0.0 ) ;
				float clampResult68 = clamp( ( pow( abs( ( ase_screenPosNorm.x - 0.5 ) ) , 2.0 ) + pow( abs( ( ase_screenPosNorm.y - 0.5 ) ) , 2.0 ) ) , 0.0 , 1.0 );
				

				finalColor = ( ( ( tex2D( _MainTex, uv_MainTex ) * ( 1.0 - temp_output_71_0 ) ) + ( temp_output_71_0 * _FogColor ) ) * ( 1.0 - clampResult68 ) );
...
/*ASEBEGIN
Version=16700
434.4;148;1523;790;1229.257;-227.7026;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;51;-1034.527,2.666443;Float;False;1650.967;893.8132;Comment;14;48;49;41;2;44;47;1;21;22;71;72;75;76;77;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SinTimeNode;75;-805.2357,535.6771;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;77;-665.6718,593.8603;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-711.3797,714.6277;Float;False;Property;_BandLen;BandLen;1;0;Create;True;0;0;False;0;1;0.2;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;-478.4358,548.9771;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;6;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;56;-348.0248,1268.043;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenDepthNode;21;-743.3373,381.2421;Float;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.AbsOpNode;53;-315.8051,1024.95;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCIf;71;-332.0797,468.9277;Float;False;6;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;4;FLOAT;0;False;5;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;44;-128.5095,710.7316;Float;False;Property;_FogColor;FogColor;0;0;Create;True;0;0;False;0;0.8490566,0.5946379,0.4445532,0;0.3478297,0.3409131,0.4433962,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7F05960E01D0CC76964DCD8EE189A2ABA384EA64